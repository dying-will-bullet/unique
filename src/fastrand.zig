...
const Rng = struct {
    ...
    pub fn gen_u64(self: *Self) u64 {
        ...
        self.seed = new_seed;
        const value = @intCast(u128, new_seed) * @intCast(u128, new_seed ^ 0xE7037ED1A0B428DB);
        return @truncate(u64, value) ^ @truncate(u64, (value >> 64));
    }

    pub fn gen_u32(self: *Self) u32 {
        return @truncate(u32, self.gen_u64());
    }

    pub fn gen_u8(self: *Self) u8 {
        return @truncate(u8, self.gen_u32());
    }
